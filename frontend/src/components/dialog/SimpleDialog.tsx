...
const SimpleDialog: FC<Props> = ({ isOpen, children, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="zoom-in overflow-hidden fade-in flex flex-col bg-white dark:bg-gray-900 absolute top-0 bottom-0 left-0 right-0 p-4 sm:p-8 m-8 sm:m-16 md:m-24 lg:m-32 rounded-lg shadow-xl"
        onClick={(e) => {
          e.preventDefault();
          e.stopPropagation();
        }}
